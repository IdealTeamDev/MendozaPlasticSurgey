...
target_keys = ["group_procedimiento_cpt", "group_procedimientos_page"]
patch_data = []
...
with open('/Users/user/Documents/Mendoza/MendozaPlasticSurgey/acf-parche-seguro.json', 'w') as f:
    json.dump(patch_data, f, indent=4)

print("Patch JSON created successfully with show_in_rest = 1.")
