    ...
    <section className="contact-hero">
      ...
      <div className="container contact-hero-container">
        <div className="contact-hero-content">
          <p className="contact-hero-subtitle">¡ESTAMOS AQUÍ PARA AYUDARTE Y</p>
          <h1 className="contact-hero-title">RESOLVER TUS DUDAS!</h1>
          <p className="contact-hero-desc">
            Nuestro equipo bilingüe está preparado para aclarar tus inquietudes y guiarte en tu camino hacia la transformación que deseas.
          </p>
        </div>
        ...
        <div className="contact-hero-image-wrapper">
          <div className="contact-hero-image-card">
            ...
            {/* <Image src="/contact-hero.jpg" alt="Atención al paciente" fill className="contact-img" /> */}
          </div>
        </div>
      </div>
